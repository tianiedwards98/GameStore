    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="text" id="esrbRating" name="esrbRating" className="form-control" value={game.esrbRating} onChange={handleChange} />
        </div>
         <div className="mb-3">
         ...
         <div className="mb-3">
          ...
          <input type="text" id="price" name="price" className="form-control" value={game.price} onChange={handleChange} />
        </div>
         <div className="mb-3">
         ...
         <div className="mb-3">
          ...
          <input type="text" id="quantity" name="quantity" className="form-control" value={game.quantity} onChange={handleChange} />
        </div>
         <div className= "mb-3">
